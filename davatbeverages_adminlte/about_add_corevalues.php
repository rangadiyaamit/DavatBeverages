...
$id = $_GET['id'] ?? '';
if ($id) {
    $sql = "SELECT * FROM core_values WHERE id='$id'";
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if ($id) {
        $sql = "UPDATE core_values SET title='$title',image='$old_img',description='$description',status='$status' WHERE id='$id'";
        // print_r($id);
        // exit;
    } else {
        $sql = "INSERT INTO core_values (title,image,description,status) VALUES ( '$title','$old_img','$description','$status')";
    }
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            <a href="about_core_values.php" class="nav-link  active">
                                <p>
                                    About as
                                    <i class="right fas fa-angle-left"></i>
                                </p>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Our Core Values</h1>
                        </div>
                        <div class="col-md-6 text-right">
                            <a href="about_core_values.php" class="btn btn-primary">Back</a>
                        </div>
                        <!-- /.col -->
                        <!-- /.col -->
                    </div><!-- /.row -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group text-center">
                                            ...
                                            <textarea name="description" class="form-control description" placeholder="Enter description" rows="11"><?php echo $data['description'] ?? '' ?></textarea>
                                        </div>
