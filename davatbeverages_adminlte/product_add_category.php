...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($id) {
        $sql = "UPDATE product_category SET name='$name',status='$status' WHERE id='$id'";
    } else {
        $sql = "INSERT INTO product_category (name,status) VALUES ('$name','$status')";
    }
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <div class="col-md-6 text-right">
                            <a href="product_category.php" class="btn btn-primary">Back</a>
                        </div>
                        <!-- /.col -->
                        <!-- /.col -->
                    </div><!-- /.row -->
                ...
                <div class="container-fluid">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"><?php $head_title = 'Add category';
                                                    if ($id) {
